...
function ReceiptEmail(_a) {
    ...
    var total = (0, utils_1.getTotalProductsPrice)(products, 1);
            ...
            React.createElement(components_1.Container, { style: container },
                React.createElement(components_1.Section, null,
                    React.createElement(components_1.Column, null,
                        React.createElement(components_1.Img, { src: "".concat(process.env.NEXT_PUBLIC_SERVER_URL, "/sent-email.svg"), width: "100", height: "100", alt: "DigitalHippo" })),
