...
exports.PaymentRouter = (0, trpc_1.router)({
    createSession: trpc_1.privateProcedure
        ...
        var user = _a.ctx.user, input = _a.input;
        return __awaiter(void 0, void 0, void 0, function () {
            var productIds, payload, docs, filterdProducts, order, line_items, stripeSession, error_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        docs = (_b.sent()).docs;
                        filterdProducts = docs.filter(function (product) { return Boolean(product.id); });
                        return [4 /*yield*/, payload.create({
                                collection: "orders",
                                data: {
                                    _isPaid: false,
                                    products: filterdProducts.map(function (product) { return product.id; }),
                                    user: user.id,
                                },
                            })];
                    case 3:
    ...
    orderPaymentStatus: trpc_1.privateProcedure
