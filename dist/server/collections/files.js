...
var ownOrPurchased = function (_a) {
    var req = _a.req;
    return __awaiter(void 0, void 0, void 0, function () {
        var user, products, ownProductFiels, orders, purchasedProductsFiles;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    ownProductFiels = products.map(function (prod) { return prod.product_files; }).flat();
                    return [4 /*yield*/, req.payload.find({
                            collection: "orders",
                            depth: 2,
                ...
                case 2:
                    ...
                    return [2 /*return*/, {
                            id: {
                                in: __spreadArray(__spreadArray([], ownProductFiels, true), purchasedProductsFiles, true),
                            },
                        }];
            }
        });
